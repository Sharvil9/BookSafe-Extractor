  ...
  return (
    <BookProvider>
      <div className="min-h-screen w-full flex flex-col items-center justify-start bg-gradient-to-b from-amber-50 via-orange-50 to-yellow-100 px-4">
        <div className="max-w-6xl w-full mx-auto flex flex-col gap-16 pt-12">
          <header className="flex flex-col items-center gap-6">
            ...
            <h1 className="font-bold text-6xl tracking-tight text-center text-amber-900 uppercase">
              Book Crop & OCR Tool
            </h1>
            <p className="text-amber-700 text-center text-2xl max-w-4xl font-medium leading-relaxed">
              A sacred tool to crop, remove, OCR and export ancient knowledge—all processed locally on your device with the power of the spice.
            </p>
          </header>
          <BookUploader />
          <BookPagePreview />
